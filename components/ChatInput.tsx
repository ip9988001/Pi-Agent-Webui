...
export interface ChatInputHandle {
  ...
  insertAndSend: (text: string) => void;
...
export const ChatInput = forwardRef<ChatInputHandle, Props>(function ChatInput({
  ...
  useImperativeHandle(ref, () => ({
    ...
    insertAndSend(text: string) {
      const payload = text.trim();
      if (!payload || isStreaming) return;
      onSend(payload, attachedImages.length ? attachedImages : undefined);
      setValue("");
      clearImages();
      requestAnimationFrame(() => {
  ...
  }), [attachedImages, clearImages, handleSend, isStreaming, onSend, processImageFiles, value]);
